...
public class ClientLogin extends JFrame {
	...
	//private MainDataForDelivery md2;

	
	public ClientLogin(MainDataForDelivery md) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int logrez=v.verificareClient(username.getText(), password.getText());
				if(logrez==1) {
					Client cl=new Client(md);
					cl.show();
					dispose();
				}
				else
		...
		btnNewButton.setBounds(178, 340, 142, 38);
		...
		JButton btnNewButton_2 = new JButton("New Client? Sign Up");
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				NewClient nc=new NewClient(md);
				nc.show();
				dispose();
		...
		btnNewButton_2.setBounds(326, 407, 160, 26);
